...
output_pb_path = "object_detection_3d_chair.pb"
...
def main():
    ...
    with tf.compat.v1.Session(config=config, graph=graph) as sess:
        ...
        shutil.rmtree('saved_model_object_detection_3d_chair', ignore_errors=True)
...
"""
$ saved_model_cli show --dir saved_model_object_detection_3d_chair --all
