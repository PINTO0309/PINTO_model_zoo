...
with open('struct2depth_128x416_kitti_depth_full_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - struct2depth_128x416_kitti_depth_full_integer_quant.tflite")
...
tflite_quant_model = converter.convert()
with open('struct2depth_128x416_cityscapes_depth_full_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
