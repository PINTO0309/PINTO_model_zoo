...
converter.save('tensorrt_saved_model_efficientnet_lite1_224x224_float32')
...
converter.convert()
converter.build(input_fn=input_fn)
converter.save('tensorrt_saved_model_efficientnet_lite1_224x224_float16')



model = tf.saved_model.load('tensorrt_saved_model_efficientnet_lite1_224x224_float16', tags=[tf.saved_model.SERVING])
