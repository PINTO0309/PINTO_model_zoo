...
class YOLOX(AbstractModel):
    def __init__(
        ...
        *,
        runtime: Optional[str] = 'onnx',
        model_path: Optional[str] = 'yolox_x_body_head_hand_face_dist_0154_0.5658_post_1x3x480x640.onnx',
        class_score_th: Optional[float] = 0.35,
...
def main():
    ...
    parser.add_argument(
        ...
        '--model',
        type=str,
        default='yolox_x_body_head_hand_face_dist_0154_0.5658_post_1x3x480x640.onnx',
