...
with open('ssdlite_mobiledet_edgetpu_320x320_coco_weight_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Weight Quantization complete! - ssdlite_mobiledet_edgetpu_320x320_coco_weight_quant.tflite")