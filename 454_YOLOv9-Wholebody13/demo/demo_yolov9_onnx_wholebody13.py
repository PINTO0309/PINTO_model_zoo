...
class YOLOv9(AbstractModel):
    def __init__(
        ...
        *,
        runtime: Optional[str] = 'onnx',
        model_path: Optional[str] = 'yolov9_t_wholebody13_post_0245_1x3x544x960.onnx',
        class_score_th: Optional[float] = 0.35,
        ...
        if len(boxes) > 0:
            ...
            if len(boxes_keep) > 0:
                ...
                if not disable_left_and_right_hand_discrimination_mode:
                    hand_boxes = [box for box in result_boxes if box.classid == 9]
                    left_right_hand_boxes = [box for box in result_boxes if box.classid in [10, 11]]
                    self._find_most_relevant_hand(base_objs=hand_boxes, target_objs=left_right_hand_boxes)
                result_boxes = [box for box in result_boxes if box.classid not in [10, 11]]
        ...
        *,
        ...
        for base_obj in base_objs:
            ...
            if most_relevant_obj:
                if most_relevant_obj.classid == 10:
...
def main():
    ...
    parser.add_argument(
        ...
        '--model',
        type=str,
        default='yolov9_t_wholebody13_post_0245_1x3x544x960.onnx',
