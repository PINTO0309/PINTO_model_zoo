...
transforms = []
optimize_graph('./model.latest/', 'frozen_model.pb', transforms, input_name, output_node_names, outname='optimized_frozen_model.pb')

# convert this to a TF Serving compatible mode - frozen_model
shutil.rmtree('./saved_model', ignore_errors=True)
convert_graph_def_to_saved_model('./saved_model', './model.latest/optimized_frozen_model.pb', input_name, outputs)
