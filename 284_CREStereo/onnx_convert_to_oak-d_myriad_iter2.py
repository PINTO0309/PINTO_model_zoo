...
def convert(
    ...
    mul_shape = 0
    if resolution == '120x160':
        mul_shape = 70
    elif resolution == '160x240':
        mul_shape = 150
    elif resolution == '180x320':
        mul_shape = 220
    elif resolution == '240x320':
        mul_shape = 300
    elif resolution == '320x480':
        mul_shape = 600
    elif resolution == '360x640':
        mul_shape = 880
    elif resolution == '480x640':
        mul_shape = 1200
    ...
    if output_onnx_file_path:
        ...
        onnx.save(new_model, f'{os.path.splitext(input_onnx_file_path)[0]}_myriad_oak.onnx')
