...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        input = Variable(torch.randn(1, 3, size, size))
        # print(input)
        # sys.exit(0)
        ...
        # torch.save(net.state_dict(), 'yolact_edge_mobilenetv2_54_800000_opt.pth')

        torch.onnx.export(net, input, f'yolact_edge_mobilenetv2_54_800000_{size}x{size}.onnx', opset_version=12, verbose=True)
        import sys
        sys.exit(0)
