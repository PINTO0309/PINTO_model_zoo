...
schema = "schema.fbs"
binary = home + "/flatc"
model_path = "hand_landmark_3d.tflite"
output_pb_path = "hand_landmark_3d.pb"
output_savedmodel_path = "saved_model_hand_landmark_3d"
model_json_path = "hand_landmark_3d.json"
num_tensors = 387
output_node_names = ['output_handflag', 'ld_21_3d']
...
def main():
    ...
    with tf.compat.v1.Session(config=config, graph=graph) as sess:
        ...
        shutil.rmtree('saved_model_hand_landmark_3d', ignore_errors=True)
