...
# converter.optimizations = [tf.lite.Optimize.OPTIMIZE_FOR_SIZE]
# tflite_quant_model = converter.convert()
# with open('palm_detection_without_custom_op_256_weight_quant.tflite', 'wb') as w:
#     w.write(tflite_quant_model)
# print("Weight Quantization complete! - palm_detection_without_custom_op_256_weight_quant.tflite")