...
class PIPNet(AbstractModel):
    def __init__(
        self,
        *,
        runtime: Optional[str] = 'onnx',
        model_path: Optional[str] = 'pipnet_irnet18_Nx3x256x256.onnx',
        providers: Optional[List] = None,
    ):
        """
        ...
        self._swap = (0,3,1,2)
        self._mean = np.asarray([58.395, 57.12, 57.375])
        self._std = np.asarray([58.395, 57.12, 57.375])
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default='pipnet_irnet18_Nx3x256x256.onnx',
    )
    parser.add_argument(
        '-v',
        '--video',
