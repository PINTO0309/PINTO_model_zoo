...
class YOLOX(AbstractModel):
    def __init__(
        ...
        *,
        runtime: Optional[str] = 'onnx',
        model_path: Optional[str] = 'yolox_n_foot_dist_post_0199_0.3011_1x3x480x640.onnx',
        class_score_th: Optional[float] = 0.35,
    ...
    def _postprocess(
        ...
        if len(boxes) > 0:
            ...
            if len(boxes_keep) > 0:
                ...
                hand_boxes = [box for box in result_boxes if box.classid == 3]
                left_right_hand_boxes = [box for box in result_boxes if box.classid in [4, 5]]
                self._find_most_relevant_hand(base_objs=hand_boxes, target_objs=left_right_hand_boxes)
                result_boxes = [box for box in result_boxes if box.classid not in [4, 5]]
...
def main():
    ...
    parser.add_argument(
        ...
        '--model',
        type=str,
        default='yolox_x_foot_dist_post_0157_0.5195_1x3x480x640.onnx',
