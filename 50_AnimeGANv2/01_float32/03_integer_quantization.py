...
with open('animeganv2_hayao_256x256_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - animeganv2_hayao_256x256_integer_quant.tflite")
...
converter.representative_dataset = representative_dataset_gen
tflite_quant_model = converter.convert()
with open('animeganv2_paprika_256x256_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - animeganv2_paprika_256x256_integer_quant.tflite")
