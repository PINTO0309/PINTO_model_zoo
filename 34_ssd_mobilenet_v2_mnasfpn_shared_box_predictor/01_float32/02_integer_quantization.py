...
with open('./ssd_mobilenet_v2_mnasfpn_shared_box_predictor_320_coco_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - ssd_mobilenet_v2_mnasfpn_shared_box_predictor_320_coco_integer_quant.tflite")