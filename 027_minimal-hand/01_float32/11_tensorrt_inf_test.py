...
converter = tf.experimental.tensorrt.Converter(input_saved_model_dir='saved_model_detnet', conversion_params=params)
converter.convert()
converter.build(input_fn=input_fn_detnet)
converter.save('tensorrt_saved_model_detnet_float32')

params = tf.experimental.tensorrt.ConversionParams(precision_mode='FP16', maximum_cached_engines=1000)
converter = tf.experimental.tensorrt.Converter(input_saved_model_dir='saved_model_detnet', conversion_params=params)
converter.convert()
converter.build(input_fn=input_fn_detnet)
converter.save('tensorrt_saved_model_detnet_float16')


params = tf.experimental.tensorrt.ConversionParams(precision_mode='FP32', maximum_cached_engines=1000)
converter = tf.experimental.tensorrt.Converter(input_saved_model_dir='saved_model_iknet', conversion_params=params)
converter.convert()
converter.build(input_fn=input_fn_iknet)
converter.save('tensorrt_saved_model_iknet_float32')

params = tf.experimental.tensorrt.ConversionParams(precision_mode='FP16', maximum_cached_engines=1000)
converter = tf.experimental.tensorrt.Converter(input_saved_model_dir='saved_model_iknet', conversion_params=params)
converter.convert()
converter.build(input_fn=input_fn_iknet)
converter.save('tensorrt_saved_model_iknet_float16')



model = tf.saved_model.load('tensorrt_saved_model_detnet_float16', tags=[tf.saved_model.SERVING])
