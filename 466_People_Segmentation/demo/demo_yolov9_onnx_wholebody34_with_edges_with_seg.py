...
class YOLOv9(AbstractModel):
    def __init__(
        ...
        *,
        runtime: Optional[str] = 'onnx',
        model_path: Optional[str] = 'yolov9_e_wholebody34_with_seg_post_0100_1x3x480x640.onnx',
        obj_class_score_th: Optional[float] = 0.35,
        attr_class_score_th: Optional[float] = 0.70,
        keypoint_th: Optional[float] = 0.25,
...
def main():
    ...
    parser.add_argument(
        ...
        '--model',
        type=str,
        default='yolov9_e_wholebody34_with_seg_post_0100_1x3x480x640.onnx',
