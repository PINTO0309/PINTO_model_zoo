...
with open('./edgetpu_deeplab_257_os16_full_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - edgetpu_deeplab_257_os16_full_integer_quant.tflite")
...
converter.representative_dataset = representative_dataset_gen_257
tflite_quant_model = converter.convert()
with open('./edgetpu_deeplab_257_os32_full_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - edgetpu_deeplab_257_os32_full_integer_quant.tflite")
...
tflite_quant_model = converter.convert()
with open('./edgetpu_deeplab_321_os16_full_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - edgetpu_deeplab_321_os16_full_integer_quant.tflite")
...
converter.representative_dataset = representative_dataset_gen_321
tflite_quant_model = converter.convert()
with open('./edgetpu_deeplab_321_os32_full_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - edgetpu_deeplab_321_os32_full_integer_quant.tflite")
...
tflite_quant_model = converter.convert()
with open('./edgetpu_deeplab_513_os16_full_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - edgetpu_deeplab_513_os16_full_integer_quant.tflite")
...
converter.representative_dataset = representative_dataset_gen_513
tflite_quant_model = converter.convert()
with open('./edgetpu_deeplab_513_os32_full_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - edgetpu_deeplab_513_os32_full_integer_quant.tflite")
...
tflite_quant_model = converter.convert()
with open('./edgetpu_deeplab_769_os16_full_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - edgetpu_deeplab_769_os16_full_integer_quant.tflite")
...
converter.representative_dataset = representative_dataset_gen_769
tflite_quant_model = converter.convert()
with open('./edgetpu_deeplab_769_os32_full_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - edgetpu_deeplab_769_os32_full_integer_quant.tflite")