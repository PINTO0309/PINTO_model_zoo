...
class LowLightEnhancement:
    def __init__(self, model_path: str) -> None:
        ...
        output_shape = self.model_outputs[0].shape
    ...
    def inference(self, img_bgr):
        ...
        outputs = self.session.run(self.output_names, {self.input_names[0]: img_input})
        img_output = self.postprocess(outputs)
        return img_output
...
if __name__ == "__main__":
    ...
    exp = LowLightEnhancement(model_path)
    ...
    while cap.isOpened():
        ...
        cv2.imshow("IAT low light enhancement", shown)
