...
with open('erfnet_{}x{}_cityscapes_integer_quant.tflite'.format(height, width), 'wb') as w:
    w.write(tflite_model)
print('Integer Quantization complete! - erfnet_{}x{}_cityscapes_integer_quant.tflite'.format(height, width))
