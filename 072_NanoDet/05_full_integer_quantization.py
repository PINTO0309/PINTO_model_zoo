...
with open('nanodet_{}x{}_full_integer_quant.tflite'.format(height, width), 'wb') as w:
    w.write(tflite_model)
print('Integer Quantization complete! - nanodet_{}x{}_full_integer_quant.tflite'.format(height, width))
