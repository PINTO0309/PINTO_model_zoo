...
class FastReID(AbstractModel):
    def __init__(
        ...
        *,
        runtime: Optional[str] = 'onnx',
        model_path: Optional[str] = 'mot17_sbs_S50_NMx3x384x128_post.onnx',
...
def main():
    ...
    parser.add_argument(
        ...
        '--model',
        type=str,
        default='mot17_sbs_S50_NMx3x384x128_post.onnx',
...
Base.1: The similarities are 0.359 0.630 0.686 -0.044 0.014
Base.2: The similarities are 1.000 0.673 0.602 -0.000 0.139
Elapsed time: 25.13ms

# mot20_sbs_S50_NMx3x384x128_post.onnx
Base.1: The similarities are 0.559 0.698 0.757 0.226 0.216
Base.2: The similarities are 1.000 0.617 0.644 0.341 0.289
Elapsed time: 25.40ms
"""