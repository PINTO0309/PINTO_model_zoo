...
if __name__ == "__main__":
    ...
    selected_indices = tf_keras.layers.Input(
        shape=[
            2,
        ],
        dtype=tf.int64,
    ...
    model = tf_keras.models.Model(inputs=[boxes, selected_indices], outputs=[gathered_boxes_casted])
    model.summary()
