...
convert_graph_def_to_saved_model('./saved_model', './weights/yolov3_lite_freeze_graph.pb', 'input/input_data', ['YoloV3/pred_sbbox/concat_2:0', 'YoloV3/pred_mbbox/concat_2:0', 'YoloV3/pred_lbbox/concat_2:0'])