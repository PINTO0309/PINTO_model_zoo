...
with open('ssdlite_mobiledet_cpu_320x320_coco_integer_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Integer Quantization complete! - ssdlite_mobiledet_cpu_320x320_coco_integer_quant.tflite")