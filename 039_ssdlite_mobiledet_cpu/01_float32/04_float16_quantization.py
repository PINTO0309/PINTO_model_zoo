...
with open('ssdlite_mobiledet_cpu_320x320_coco_float16_quant.tflite', 'wb') as w:
    w.write(tflite_quant_model)
print("Float16 Quantization complete! - ssdlite_mobiledet_cpu_320x320_coco_float16_quant.tflite")