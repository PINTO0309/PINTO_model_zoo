...
shutil.rmtree('./3_saved_model', ignore_errors=True)
convert_graph_def_to_saved_model('./3_saved_model', './1_checkpoint/16_bit_HE_to_HE_gt/lsmod_256.pb', 'input', ['output:0'])