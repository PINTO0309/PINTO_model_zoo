...
shutil.rmtree('./models/saved_model', ignore_errors=True)
convert_graph_def_to_saved_model('./models/saved_model', './models/bts_densenet161_480_640_freeze_graph.pb', 'input', ['model/decoder/mul_16:0','model/decoder/truediv_3:0','model/decoder/truediv_9:0','model/decoder/truediv_15:0'])
