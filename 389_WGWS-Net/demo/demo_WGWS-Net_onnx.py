...
def main():
    ...
    parser.add_argument(
        "--model",
        type=str,
        # default='set3/wgws_net_set2_spaplus_480x640.onnx',  # DeRain
        # default='set3/wgws_net_set2_realsnow_480x640.onnx',  # DeSnow
        default='set3/wgws_net_set2_realhaze_480x640.onnx',  # DeHaze
    )
    ...
    while True:
        ...
        if key == 27:  # ESC
            break
        cv.imshow('WGWS-Net Input', debug_image)
        cv.imshow('WGWS-Net Output', output_image)
