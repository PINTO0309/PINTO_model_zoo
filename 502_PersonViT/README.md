...
- unified test set eval
  ...
  | Var | Backbone | Params | GFLOPs<br>@256x128 | Emb | mAP | Rank-1 | Rank-5 | Rank-10 |
  | --- | --- | ---: | ---: | ---: | --- | ---: | ---: | ---: |
  | S-ain-aug | ViT-S/16<br>+<br>token-IN | 22.0M | 2.94 | 384 | 93.0 | 97.0 | 98.2 | 98.5 |

- official dataset eval

  | dataset | queries | gallery | mAP | R1 | R5 | R10 |
  | --- | ---: | ---: | ---: | ---: | ---: | ---: |
  | market | 3,368 | 15,913 | 0.9858 | 0.9902 | 0.9976 | 0.9988 |
  | msmt17 | 11,659 | 82,161 | 0.9329 | 0.9666 | 0.9851 | 0.9878 |
  | duke_occ | 2,210 | 17,661 | 0.9473 | 0.9652 | 0.9819 | 0.9864 |
  | cuhk03np | 1,400 | 5,332 | 0.9876 | 0.9900 | 0.9943 | 0.9986 |
  | occ_reid | 1,000 | 1,000 | 0.9979 | 0.9990 | 0.9990 | 1.0000 |
...
- official dataset style-shift eval - query only shifted
  ...
  | --- | ---: | ---: | ---: | ---: |
  | clean | 0.9508 | 0.9739 | — | — |
  | bright+30% | 0.9497 | 0.9724 | -0.0011 | -0.0015 |
  | dark-30% | 0.9508 | 0.9737 | -0.0000 | -0.0002 |
  | contrast-40% | 0.9508 | 0.9737 | -0.0000 | -0.0002 |
  | contrast+40% | 0.9022 | 0.9357 | -0.0486 | -0.0381 |
  | warm | 0.9168 | 0.9485 | -0.0340 | -0.0254 |
  | cool | 0.9367 | 0.9647 | -0.0141 | -0.0092 |
  | gamma0.6 | 0.9431 | 0.9695 | -0.0077 | -0.0043 |
  | gamma1.6 | 0.9395 | 0.9680 | -0.0113 | -0.0059 |
  | jpeg-q40 | 0.9467 | 0.9712 | -0.0041 | -0.0026 |
  | jpeg-q20 | 0.9359 | 0.9657 | -0.0149 | -0.0082 |
...
- official dataset eval
  ...
  | dataset | queries | gallery | mAP | R1 | R5 | R10 |
  | --- | ---: | ---: | ---: | ---: | ---: | ---: |
  | market | 3,368 | 15,913 | 0.9704 | 0.9843 | 0.9952 | 0.9979 |
  | msmt17 | 11,659 | 82,161 | 0.8720 | 0.9473 | 0.9763 | 0.9816 |
  | duke_occ | 2,210 | 17,661 | 0.9063 | 0.9339 | 0.9751 | 0.9810 |
  | cuhk03np | 1,400 | 5,332 | 0.9800 | 0.9821 | 0.9950 | 0.9986 |
  | occ_reid | 1,000 | 1,000 | 0.9813 | 0.9850 | 0.9910 | 0.9980 |
...
- official dataset style-shift eval - query only shifted
  ...
  | --- | ---: | ---: | ---: | ---: |
  | clean | 0.9060 | 0.9566 | — | — |
  | bright+30% | 0.9023 | 0.9550 | -0.0036 | -0.0016 |
  | dark-30% | 0.9045 | 0.9566 | -0.0015 | +0.0001 |
  | contrast-40% | 0.9060 | 0.9566 | +0.0000 | +0.0001 |
  | contrast+40% | 0.8111 | 0.8721 | -0.0948 | -0.0845 |
  | warm | 0.8006 | 0.8687 | -0.1054 | -0.0879 |
  | cool | 0.8170 | 0.8849 | -0.0890 | -0.0717 |
  | gamma0.6 | 0.8810 | 0.9391 | -0.0250 | -0.0174 |
  | gamma1.6 | 0.8705 | 0.9338 | -0.0354 | -0.0227 |
  | jpeg-q40 | 0.8989 | 0.9532 | -0.0071 | -0.0034 |
  | jpeg-q20 | 0.8773 | 0.9363 | -0.0287 | -0.0202 |
...
- unified test set eval
  ...
  | Var | Backbone | Params | GFLOPs<br>@256x128 | Emb | mAP | Rank-1 | Rank-5 | Rank-10 |
  | --- | --- | ---: | ---: | ---: | --- | ---: | ---: | ---: |
  | N-ain-aug | OSNet-AIN x1.25 | 3.3M | 1.49 | 512 | 88.9 | 95.5 | 97.5 | 98.1 |

- official dataset eval

  | dataset | queries | gallery | mAP | R1 | R5 | R10 |
  | --- | ---: | ---: | ---: | ---: | ---: | ---: |
  | market | 3,368 | 15,913 | 0.9703 | 0.9860 | 0.9961 | 0.9988 |
  | msmt17 | 11,659 | 82,161 | 0.8674 | 0.9436 | 0.9759 | 0.9811 |
  | duke_occ | 2,210 | 17,661 | 0.9015 | 0.9290 | 0.9742 | 0.9810 |
  | cuhk03np | 1,400 | 5,332 | 0.9802 | 0.9836 | 0.9943 | 0.9986 |
  | occ_reid | 1,000 | 1,000 | 0.9783 | 0.9840 | 0.9910 | 0.9990 |
...
- official dataset style-shift eval - query only shifted
  ...
  | --- | ---: | ---: | ---: | ---: |
  | clean | 0.9026 | 0.9541 | — | — |
  | bright+30% | 0.8988 | 0.9516 | -0.0038 | -0.0025 |
  | dark-30% | 0.9011 | 0.9536 | -0.0015 | -0.0005 |
  | contrast-40% | 0.9026 | 0.9546 | -0.0000 | +0.0005 |
  | contrast+40% | 0.8101 | 0.8703 | -0.0925 | -0.0838 |
  | warm | 0.7908 | 0.8574 | -0.1118 | -0.0967 |
  | cool | 0.8224 | 0.8907 | -0.0802 | -0.0634 |
  | gamma0.6 | 0.8806 | 0.9403 | -0.0220 | -0.0139 |
  | gamma1.6 | 0.8655 | 0.9295 | -0.0371 | -0.0246 |
  | jpeg-q40 | 0.8951 | 0.9503 | -0.0075 | -0.0038 |
  | jpeg-q20 | 0.8736 | 0.9335 | -0.0290 | -0.0206 |
...
- unified test set eval
  ...
  | Var | Backbone | Params | GFLOPs<br>@256x128 | Emb | mAP | Rank-1 | Rank-5 | Rank-10 |
  | --- | --- | ---: | ---: | ---: | --- | ---: | ---: | ---: |
  | P-ain-aug | OSNet-AIN x1.0 | 2.2M | 0.98 | 512 | 88.6 | 95.2 | 97.5 | 98.1 |

- official dataset eval

  | dataset | queries | gallery | mAP | R1 | R5 | R10 |
  | --- | ---: | ---: | ---: | ---: | ---: | ---: |
  | market | 3,368 | 15,913 | 0.9687 | 0.9857 | 0.9955 | 0.9973 |
  | msmt17 | 11,659 | 82,161 | 0.8655 | 0.9458 | 0.9762 | 0.9815 |
  | duke_occ | 2,210 | 17,661 | 0.9002 | 0.9335 | 0.9729 | 0.9796 |
  | cuhk03np | 1,400 | 5,332 | 0.9785 | 0.9843 | 0.9921 | 0.9971 |
  | occ_reid | 1,000 | 1,000 | 0.9848 | 0.9880 | 0.9940 | 0.9970 |
...
- official dataset style-shift eval - query only shifted
  ...
  | --- | ---: | ---: | ---: | ---: |
  | clean | 0.9012 | 0.9562 | — | — |
  | bright+30% | 0.8973 | 0.9534 | -0.0039 | -0.0028 |
  | dark-30% | 0.8998 | 0.9552 | -0.0015 | -0.0010 |
  | contrast-40% | 0.9012 | 0.9562 | +0.0000 | +0.0000 |
  | contrast+40% | 0.8104 | 0.8742 | -0.0908 | -0.0820 |
  | warm | 0.8065 | 0.8775 | -0.0947 | -0.0787 |
  | cool | 0.8316 | 0.9014 | -0.0696 | -0.0548 |
  | gamma0.6 | 0.8824 | 0.9447 | -0.0188 | -0.0115 |
  | gamma1.6 | 0.8643 | 0.9306 | -0.0370 | -0.0256 |
  | jpeg-q40 | 0.8937 | 0.9506 | -0.0076 | -0.0056 |
  | jpeg-q20 | 0.8714 | 0.9346 | -0.0298 | -0.0216 |
