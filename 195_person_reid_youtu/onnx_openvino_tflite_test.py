...
ie = IECore()
net = ie.read_network(
    model=f'saved_model_person_reid_youtu/openvino/FP32/person_reid_youtu_2021nov_batch1.xml',
    weights=f'saved_model_person_reid_youtu/openvino/FP32/person_reid_youtu_2021nov_batch1.bin'
)
...
interpreter = tf.lite.Interpreter(model_path=f'saved_model_person_reid_youtu/model_float32.tflite', num_threads=4)
