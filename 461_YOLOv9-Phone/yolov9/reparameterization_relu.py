...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg', type=str, default='./models/detect/gelan-t-relu.yaml', help='model.yaml path')
    parser.add_argument('--weights', type=str, default='./best-t-relu.pt', help='weights path')
    parser.add_argument('--save', default=f'./yolov9_wholebody_with_wheelchair_t_relu.pt', type=str, help='save path')
