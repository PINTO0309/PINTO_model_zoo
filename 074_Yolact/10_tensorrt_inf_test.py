...
converter = tf.experimental.tensorrt.Converter(input_saved_model_dir='saved_model_from_pb', conversion_params=params)
converter.convert()
...
model = tf.saved_model.load('tensorrt_saved_model_{}x{}_float32'.format(height, width), tags=[tf.saved_model.SERVING])
