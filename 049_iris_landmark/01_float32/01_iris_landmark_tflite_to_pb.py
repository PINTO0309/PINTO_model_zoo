...
output_pb_path = "iris_landmark.pb"
output_savedmodel_path = "saved_model"
model_json_path = "iris_landmark.json"
num_tensors = 386
output_node_names = ['output_eyes_contours_and_brows', 'output_iris']
...
def main():
    ...
    with tf.compat.v1.Session(config=config, graph=graph) as sess:
        ...
        tf.compat.v1.saved_model.simple_save(
            ...
            outputs={
                'output_eyes_contours_and_brows': graph.get_tensor_by_name('output_eyes_contours_and_brows:0'),
                'output_iris': graph.get_tensor_by_name('output_iris:0')
            })
...
signature_def['serving_default']:
  ...
  The given SavedModel SignatureDef contains the following output(s):
    outputs['output_eyes_contours_and_brows'] tensor_info:
        dtype: DT_FLOAT
        shape: (1, -1)
        name: output_eyes_contours_and_brows:0
    outputs['output_iris'] tensor_info:
        dtype: DT_FLOAT
        shape: (1, -1)
        name: output_iris:0
