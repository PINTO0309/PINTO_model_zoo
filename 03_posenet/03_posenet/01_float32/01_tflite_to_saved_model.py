...
output_pb_path = "posenet_mobilenet_v1_100_257x257_multi_kpt_stripped.pb"
output_savedmodel_path = "saved_model_posenet_mobilenet_v1_100_257x257_multi_kpt_stripped"
model_json_path = "posenet_mobilenet_v1_100_257x257_multi_kpt_stripped.json"
num_tensors = 94
...
def main():
    ...
    with tf.compat.v1.Session(config=config, graph=graph) as sess:
        ...
        shutil.rmtree('saved_model_posenet_mobilenet_v1_100_257x257_multi_kpt_stripped', ignore_errors=True)
