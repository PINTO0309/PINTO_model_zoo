...
with tf.compat.v1.Session() as sess:
    ...
    with gfile.FastGFile('_tf_models/posenet/mobilenet_float_100/stride8/saved_model.pb', 'rb') as f:
    ...
    optimized_graph_def = TransformGraph(
                              ...
                              'image',
                              ['MobilenetV1/heatmap_2/BiasAdd','MobilenetV1/offset_2/BiasAdd','MobilenetV1/displacement_fwd_2/BiasAdd','MobilenetV1/displacement_bwd_2/BiasAdd'],
                              ['strip_unused_nodes(type=float, shape="1,513,513,3")'])

    tf.io.write_graph(optimized_graph_def, './', 'posenet_mobilenetv1_dm100_8_513.pb', as_text=False)